...
const tokenName = 'StudentReward';
const tokenSymbol = 'SW';
const totalSupply = 1000000; // Total supply of tokens

// Set up the distribution details
const distributionList = [
  { recipientAddress: 'RECIPIENT_ADDRESS_1', amount: 200 },
  { recipientAddress: 'RECIPIENT_ADDRESS_2', amount: 300 },
  { recipientAddress: 'RECIPIENT_ADDRESS_3', amount: 500 },
];
